...
export type ProductRecommendationsQueryVariables = StorefrontAPI.Exact<{
  ...
  variantsFirst?: StorefrontAPI.InputMaybe<
    StorefrontAPI.Scalars['Int']['input']
  >;
  imagesFirst?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
}>;
...
export type ProductRecommendationsQuery = {
  productRecommendations?: StorefrontAPI.Maybe<
    Array<
      Pick<
        StorefrontAPI.Product,
        'description' | 'handle' | 'id' | 'productType' | 'tags' | 'title'
      > & {
        ...
        images: {
          edges: Array<{
            node: Pick<StorefrontAPI.Image, 'id' | 'originalSrc' | 'altText'>;
          }>;
        };
        priceRange: {
        ...
        variants: {
          edges: Array<{
            ...
            > & {
              ...
              image?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Image, 'id' | 'originalSrc' | 'altText'>
              >;
            };
          }>;
        };
...
export type ProdRecsQueryVariables = StorefrontAPI.Exact<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query prodRecs(\n    $productHandle: String!\n    $variantsFirst: Int = 1\n    $imagesFirst: Int = 5\n  ) {\n    productRecommendations(productHandle: $productHandle) {\n      featuredImage {\n        id\n        url\n        altText\n        width\n        height\n      }\n      description\n      handle\n      id\n      images(first: $imagesFirst) {\n        edges {\n          node {\n            id\n            originalSrc\n            altText\n          }\n        }\n      }\n      priceRange {\n        maxVariantPrice {\n          amount\n          currencyCode\n        }\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      productType\n      tags\n      title\n      variants(first: $variantsFirst) {\n        edges {\n          node {\n            sku\n            availableForSale\n            id\n            compareAtPriceV2 {\n              amount\n              currencyCode\n            }\n            priceV2 {\n              amount\n              currencyCode\n            }\n            title\n            image {\n              id\n              originalSrc\n              altText\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: ProdRecsQuery;
    variables: ProdRecsQueryVariables;
  };
